 ...
 * - Gray maze background overlay (fixed, subtle)
...
// --------------------------
// Data (TECH-ONLY images)
// --------------------------
const siteData = {
  title: "Cara'sQAway", // renamed per your preferred site name
  ...
  profile: {
    ...
    // TECH image instead of person
    photoUrl: "/images/hero-tech-2.png",
    socials: [],
  },
  // TECH bar (no people/food)
  techBarImages: [
  ...
  // TECH-only Bug Jam thumbnails (no people/food) — switched all to /view
  bugJams: [
...
function PatternOverlay() {
  // fixed, subtle gray maze overlay using a local SVG
  return (
    <div
      aria-hidden
